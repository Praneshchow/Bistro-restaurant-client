...
const Featured = () => {
    return (
        <div className="featured-item bg-fixed pt-8 my-20">
            ...
            <div className="md:flex justify-center items-center pb-20 pt-12 px-36 bg-slate-700 bg-opacity-70">
                <div>
                ...
                <div className="md:ml-10">   
                    ...
                    <button className="btn btn-outline btn-warning border-0 border-b-4 mt-3">Order Now</button>
                </div>
            </div>
        </div>
    );
